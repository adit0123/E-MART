...
public class DBConnection {
    ...
    static
    {
        try
        {
            ...
            conn=DriverManager.getConnection("jdbc:oracle:thin:@//LAPTOP-GTCH9DCU:1521/xe","grocery","project");
            JOptionPane.showMessageDialog(null,"Connection opened successfully","Success!",JOptionPane.ERROR_MESSAGE);
            
        }
        catch(ClassNotFoundException ex)
        {
            JOptionPane.showMessageDialog(null,"Error in loading the drive","Drive Error!",JOptionPane.ERROR_MESSAGE);
            ex.printStackTrace();
            System.exit(1);
        }
